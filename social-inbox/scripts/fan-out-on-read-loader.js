...
var fixedNames = ["aaaaho", "aaaald", "aaaao", "aaaaxen", "aaaaxvx", "aaabajwpg", "aaabc", "aaabcpmo", "aaabfjfu", "aaabg", "aaabrpohbl", "aaabxj", "aaacivtjp", "aaacnlrdadi", "aaacpjxu", "aaacrv",
...
function getRandomUsernames(max) {
	var names = [];
	var numNames = getRandomInt(1,max);
	for (var j = 0; j < numNames; j++) {
	    names.push(getRandomUsername());
	}
	int random = getRandomInt(1,100)
	if (numNames < max && random == 13) {
		names.push(fixedNames[getRandomInt(0, fixedNames.length - 1)]);
	}
}
