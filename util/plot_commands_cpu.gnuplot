...
set y2label "%"
set title "commands and user cpu"
...
plot \
file using 6 title "commands per sec" with points pt 7 lt 1 ps 1, \
file using 20 axes x1y2 title "%user cpu" with lines linecolor rgb "blue" linetype 7 lw 2.5
