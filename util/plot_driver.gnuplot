...
plot \
file using 1:2 axes x1y1 title "requests per sec" with points lt 1 pt 3 lc rgb "red" ps 1, \
file using 1:3 axes x1y2 title "read latency (milliseconds)" with points lt 1 pt 5 lc rgb "black" ps 1, \
file using 1:4 axes x1y2 title "write latency (milliseconds)" with points lt 1 pt 8 lc rgb "green" ps 1
